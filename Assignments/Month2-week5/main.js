...
async function fetchAllCards() {
    try {
        ...
        updatePaginationControls(currentPage, totalPages, paginationControls); // Update pagination buttons
    } catch (error) {
...
async function renderCards(page, cards = filteredCards) {
...
function handleSearch({ searchTerm, category }) {
    ...
    updatePaginationControls(currentPage, totalPages, paginationControls); // Update pagination controls
}

// Update pagination controls
function updatePaginationControls(currentPage, totalPages, paginationControls) {
